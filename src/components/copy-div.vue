  ...
  export default {
    ...
    methods: {
      ...
      addMoveContentControl(divEle,e){
        ...
        let move = divEle;                                                 // 获取移动元素
        let direction = divEle.getElementsByClassName("s-move-content-direction");           // 获取所有拉伸的节点
      ...
      addMoveContentMove(divEle,e,thisEle){ // 移动
        ...
        let top  = this.divTop + this.y;
        let left = this.divLeft + this.x;
        this.space.move.content.top = top;
        this.space.move.content.left = left;
      ...
      addMoveContentTop(divEle,e,thisEle){ // 向上拉伸
        ...
        this.space.move.content.top = top;
        this.space.move.content.height = height;
        this.divStyle.top    = top + "px";
      ...
      addMoveContentRightTop(divEle,e,thisEle){ // 右上拉伸
        ...
        if(width < this.min)
          ...
          top = this.divTop + this.y;
        this.space.move.content.top = top;
        this.space.move.content.width = width;
        this.space.move.content.height = height;
        this.divStyle.top    = top + "px";
