<template>
  <div id="app">
    ...
    <div id="board" class="board" :style="changeStyle">
      <transform_div :myStyle="style">
        <div
          style="position: relative; margin: 0; overflow: hidden; word-break: break-all; width: 100%; height: 100%; color:#2c3e50;">
          {{joydivision}}
        </div>
      </transform_div>
      <transform_div :myStyle="style">
